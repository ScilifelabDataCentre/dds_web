...
def test_convert_from_bytes_base_10(): 
    """Test known values for bytes conversion, base 10."""
    from dds_web.utils import convert_from_bytes
    level_results: typing.Dict = {
        1: {"KB": 0.001, "MB": 0.000001, "GB": 0.000000001, "TB": 0.000000000001, "PB": 0.000000000000001},
        1000: {"KB": 1, "MB": 0.001, "GB": 0.000001, "TB": 0.000000001, "PB": 0.000000000001},
        1000000: {"KB": 1000, "MB": 1, "GB": 0.001, "TB": 0.000001, "PB": 0.000000001},
        1000000000: {"KB": 1000000, "MB": 1000, "GB": 1, "TB": 0.001, "PB": 0.000001},
        1000000000000: {"KB": 1000000000, "MB": 1000000, "GB": 1000, "TB": 1, "PB": 0.001},
        1000000000000000: {"KB": 1000000000000, "MB": 1000000000, "GB": 1000000, "TB": 1000, "PB": 1},
        1573927459: {"KB": 1573927.459, "MB": 1573.927459, "GB": 1.573927459, "TB": 0.001573927459, "PB": 0.000001573927459},
    }
    # Verify results
    for num_bytes, levels in level_results.items():
        for lev, expected_result in levels.items():
            assert convert_from_bytes(num_bytes=num_bytes, convert_to=lev) == expected_result
            assert convert_from_bytes(num_bytes=num_bytes, convert_to=lev, base=10) == expected_result
            assert convert_from_bytes(num_bytes=num_bytes, convert_to=lev, base=2) != expected_result

def test_convert_from_bytes_base_2(): 
    """Test known values for bytes conversion, base 2."""
    from dds_web.utils import convert_from_bytes
    level_results: typing.Dict = {
        1: {"KB": 0.0009765625, "MB": 9.5367431640625e-07, "GB": 9.313225746154785e-10, "TB": 9.094947017729282e-13, "PB": 8.881784197001252e-16},
        1024: {"KB": 1, "MB": 0.0009765625, "GB": 9.5367431640625e-07, "TB": 9.313225746154785e-10, "PB": 9.094947017729282e-13},
        1048576: {"KB": 1024, "MB": 1, "GB": 0.0009765625, "TB": 9.5367431640625e-07, "PB": 9.313225746154785e-10},
        1073741824: {"KB": 1048576, "MB": 1024, "GB": 1, "TB": 0.0009765625, "PB": 9.5367431640625e-07},
        1099511627776: {"KB": 1073741824, "MB": 1048576, "GB": 1024, "TB": 1, "PB": 0.0009765625},
        1125899906842624: {"KB": 1099511627776, "MB": 1073741824, "GB": 1048576, "TB": 1024, "PB": 1},
        1000000: {"KB": 976.5625, "MB": 0.95367431640625, "GB": 0.0009313225746154785, "TB": 9.094947017729282e-07, "PB": 8.881784197001252e-10},
    }
    # Verify results
    for num_bytes, levels in level_results.items():
        for lev, expected_result in levels.items():
