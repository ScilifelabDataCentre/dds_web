...
def test_convert_from_bytes_base_10():
    ...
    for num_bytes, levels in level_results.items():
        for lev, expected_result in levels.items():
            ...
            assert (
                convert_from_bytes(num_bytes=num_bytes, convert_to=lev, base=10) == expected_result
            )
            assert (
                convert_from_bytes(num_bytes=num_bytes, convert_to=lev, base=2) != expected_result
            )
...
def test_convert_from_bytes_base_2():
    ...
    level_results: typing.Dict = {
        1: {
            ...
            "PB": 8.881784197001252e-16,
        },
        1024: {
            "KB": 1,
            "MB": 0.0009765625,
            "GB": 9.5367431640625e-07,
            "TB": 9.313225746154785e-10,
            "PB": 9.094947017729282e-13,
        },
        1048576: {
            "KB": 1024,
            "MB": 1,
            "GB": 0.0009765625,
            "TB": 9.5367431640625e-07,
            "PB": 9.313225746154785e-10,
        },
        1073741824: {
            "KB": 1048576,
            "MB": 1024,
        ...
        1000000: {
            "KB": 976.5625,
            "MB": 0.95367431640625,
            "GB": 0.0009313225746154785,
            "TB": 9.094947017729282e-07,
            "PB": 8.881784197001252e-10,
        },
    }
    # Verify results
    for num_bytes, levels in level_results.items():
