...
def test_remove_user_self_deletion_request_no_request(client: flask.testing.FlaskClient) -> None:
    ...
    deletion_request: models.DeletionRequest = models.DeletionRequest.query.filter_by(
...
def test_remove_user_self_deletion_request_sqlalchemyerror(
    ...
    deletion_request: models.DeletionRequest = models.DeletionRequest.query.filter_by(
        requester_id=deletion_request.requester_id
    ).first()
    assert deletion_request
