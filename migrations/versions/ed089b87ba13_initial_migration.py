...
Revision ID: ed089b87ba13
Revises: 
Create Date: 2022-02-16 12:46:11.134281
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column("temporary_key", sa.LargeBinary(length=32), nullable=True),
    ...
    op.create_index(
        op.f("ix_projectuserkeys_user_id"), "projectuserkeys", ["user_id"], unique=False
    )
    op.create_table(
        "projectusers",
        sa.Column("project_id", sa.Integer(), nullable=False),
...
def downgrade():
    ...
    op.drop_index(op.f("ix_projectuserkeys_user_id"), table_name="projectuserkeys")
