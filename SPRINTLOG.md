...
- Adapted Message of the Day function to work asynchronous using the Redis Queue. Set MOTD as a background task([#1594](https://github.com/ScilifelabDataCentre/dds_web/pull/1594))
