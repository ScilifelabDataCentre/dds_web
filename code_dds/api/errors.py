...
errors = {
    "BucketNameNotFoundError": {
        "message": "Could not get S3 bucket name.",
        "status": 500
    },
    "ProjectSizeError": {
        "message": "Could not get size of project.",
        "status": 500
    },
    "DBFileError": {
        "message": "Failed to get files from database.",
        "status": 500
    },
    "FolderSizeError": {
    ...
    "FileDeletionError": {
        "message": "Deletion of file(s) from database failed.",
        "status": 500
    },
    "ItemDeletionError": {
    ...
    "FileRetrievalError": {
        "message": "Retrieval of file(s) from database failed.",
        "status": 500
    }
}
